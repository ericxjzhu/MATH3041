...
plt.plot(years_ph,world_ph_annual)
...
plt.subplot(1,2,2)
plt.semilogy(years_emissions,world_emissions) 
# define axis labels and title
plt.xlabel('Year')
...
xval = np.linspace(1988,2022,1000) # define  values from 1960 to 2030
...
lns1 = ax.plot(years_ph,world_ph_monthly,color='g',label='Monthly world pH') 
lns2 = ax.plot(years_ph,world_ph_annual,color='r',label='Annual world pH')
...
lns3=plt.semilogy(years_emissions,world_emissions) 
